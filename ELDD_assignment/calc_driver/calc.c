...
struct char_drv_private_data char_drv_data =
{
        ...
        .char_dev_data = { [0] = {.name = "ADD"},[1] = {.name = "SUB"},[2] = {.name = "MUL"},[3] = {.name = "DIV"}}
};
...
ssize_t char_dev_write(struct file *filp, const char __user *buff,
...
/*create device class under /sys/class/ */
        char_drv_data.class_char_dev =
        class_create(THIS_MODULE,"calculator_class");
...
/*populate the sysfs with device information */
        char_drv_data.device_char_dev =
        device_create(char_drv_data.class_char_dev,NULL,char_drv_dat
        a.device_number+i,NULL,"dev-%d",i+1);
